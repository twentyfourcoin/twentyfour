...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 twentyfour"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 twentyfour"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 twentyfour"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 twentyfour"));
